            ...
            <form class="form-registration needs-validation position-relative" action="javascript:void(0);" method="POST" novalidate>
                ...
                <div class="form-row">
                    ...
                    <div class="form-group col-lg-6">
                        ...
                        <input id="password"  type="password" class="form-registration-authorization__style__input form-control form-control__color__shadow__bluer" name="password"
                ...
                <div class="form-row">
                    <div class="col-lg-12 text-lg-right mt-3">
                        <button id="form-registration-submit" type="submit" class=" form-registration__btn__submit btn px-lg-5">Зарегистрироваться</button>
                    </div>
                </div>
            </form>
        </div>
